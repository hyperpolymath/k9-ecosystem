...
= Contributing — k9_gleam
:revdate: 2026-MM-DD

== Audience

Developers working *on* `k9_gleam`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/k9_gleam.git
cd k9_gleam
...
* Bugs in `k9_gleam`: file at `hyperpolymath/k9_gleam/issues`.
