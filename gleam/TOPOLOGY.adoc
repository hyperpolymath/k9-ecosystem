...
K9 format parser for Gleam with validation and error recovery. K9 is a
compact hierarchical configuration format. Provides full parser with
roundtrip fidelity and manifest extraction for trust-level and metadata
handling.
