...
Content showcase for K9 (Self-Validating Components): example `+.k9+`
files, getting-started guides, integration examples, and security-level
demonstrations. No executable code — pure content and documentation repo
for the K9 format.
