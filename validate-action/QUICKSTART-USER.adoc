...
// Replace k9-validate-action, K9 Validate Action — See README.adoc for details., just run, K9 Validate Action started successfully. with actuals
= k9-validate-action — Quick Start for Users
:toc:
:toclevels: 2

== What is k9-validate-action?

K9 Validate Action — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./k9-validate-action-portable
----
...
[source]
----
K9 Validate Action started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/k9-validate-action/wiki
